...
export default function NotFound() {
  return (
    <main
      role="alert"
      style={{ backgroundColor: '#05070f', color: '#cbd5e1', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '2rem' }}
    >
