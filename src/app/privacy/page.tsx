...
export default function PrivacyPage() {
  return (
    <main style={{ backgroundColor: '#05070f', color: '#cbd5e1', minHeight: '100vh', fontFamily: 'var(--font-body)', padding: '4rem 2rem 6rem', maxWidth: 720, margin: '0 auto', lineHeight: 1.7 }}>
      ...
      <Section heading="1. Data Controller">
        NiraNexus Ltd acts as the Data Controller for your personal data. We operate the NiraNexus-OS infrastructure — including the Model Council adversarial deliberation engine, the NiraNexus Log, Telegram integration, and associated components — at niranexus.com and its subdomains.
      </Section>
